...
def Cifar10():
	...
	valide_dataset = datasets.CIFAR10(root='dataset', train=False, transform=transform, download=True)

	train_loader = DataLoader(dataset=train_dataset, batch_size=64, shuffle=True)
	valide_loader = DataLoader(dataset=test_dataset, batch_size=64, shuffle=False)
